...
<section class="banner" role="banner">
  <header id="header"> 
    <!-- navigation section  -->
    <div class="header-content clearfix"> <a class="logo" href="/"><img src="images/logo.png" alt="Yusuf"></a>
      <nav class="navigation" role="navigation">
        <ul class="primary-nav">
          <li><a href="/afdhal">Yusuf</a></li>
          <li><a href="/aboutafdhal">About Me</a></li>
          <li><a href="contactafdhal">Contact</a></li>
        </ul>
      </nav>
