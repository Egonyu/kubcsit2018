...
<section class="banner" role="banner">
  <header id="header"> 
    <!-- navigation section  -->
    <div class="header-content clearfix"> <a class="logo" href="/"><img src="images/logo.png" alt="Egonyu"></a>
      <nav class="navigation" role="navigation">
        <ul class="primary-nav">
          <li><a href="/daniel">Egonyu Daniel</a></li>
          <li><a href="/aboutdaniel">About Me</a></li>
          <li><a href="contactdaniel">Contact</a></li>
        </ul>
      </nav>
