...
<section class="banner" role="banner">
  <header id="header"> 
    <!-- navigation section  -->
    <div class="header-content clearfix"> <a class="logo" href="/"><img src="images/logo.png" alt="Abba Lawan Saji"></a>
      <nav class="navigation" role="navigation">
        <ul class="primary-nav">
          <li><a href="/saji">saji</a></li>
          <li><a href="/aboutsaji">About Me</a></li>
          <li><a href="contactsaji">Contact</a></li>
        </ul>
      </nav>
