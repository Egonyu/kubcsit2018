...
<section class="banner" role="banner">
  <header id="header"> 
    <!-- navigation section  -->
    <div class="header-content clearfix"> <a class="logo" href="/"><img src="images/logo.png" alt="Sayf"></a>
      <nav class="navigation" role="navigation">
        <ul class="primary-nav">
          <li><a href="/sayf">Sayf</a></li>
          <li><a href="/aboutsayf">About Me</a></li>
          <li><a href="contactsayf">Contact</a></li>
        </ul>
      </nav>
