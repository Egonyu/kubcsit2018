...
<section class="innerbanner" role="banner">
  <header id="header"> 
    <!-- navigation section  -->
    <div class="header-content clearfix"> <a class="logo" href="/daniel"><img src="images/logo.png" alt="Gorofi"></a>
      <nav class="navigation" role="navigation">
        <ul class="primary-nav">
          <li><a href="/gorofi">Home</a></li>
          <li><a href="/aboutgorofi">About Me</a></li>
          <li><a href="/contactgorofi">Contact</a></li>
        </ul>
      </nav>
