...
<section class="banner" role="banner">
  <header id="header"> 
    <!-- navigation section  -->
    <div class="header-content clearfix"> <a class="logo" href="/"><img src="images/logo.png" alt="Garba"></a>
      <nav class="navigation" role="navigation">
        <ul class="primary-nav">
          <li><a href="/garba">Home</a></li>
          <li><a href="/aboutgarba">About Me</a></li>
          <li><a href="contactgarba">Contact</a></li>
        </ul>
      </nav>
