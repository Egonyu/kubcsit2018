...
<section class="banner" role="banner">
  <header id="header"> 
    <!-- navigation section  -->
    <div class="header-content clearfix"> <a class="logo" href="/"><img src="images/logo.png" alt="Mujahid"></a>
      <nav class="navigation" role="navigation">
        <ul class="primary-nav">
          <li><a href="/mujahid">Home</a></li>
          <li><a href="/aboutmujahid">About Me</a></li>
          <li><a href="contactmujahid">Contact</a></li>
        </ul>
      </nav>
