...
<title>Bello Tijjani Sarki</title>
...
<section class="innerbanner" role="banner">
  <header id="header"> 
    <!-- navigation section  -->
    <div class="header-content clearfix"> <a class="logo" href="/daniel"><img src="images/logo.png" alt="Mafolio"></a>
      <nav class="navigation" role="navigation">
        <ul class="primary-nav">
          <li><a href="/tijjani">Tijjani</a></li>
          <li><a href="/abouttijjani">About Me</a></li>
          <li><a href="/contacttijjani">Contact</a></li>
        </ul>
      </nav>
