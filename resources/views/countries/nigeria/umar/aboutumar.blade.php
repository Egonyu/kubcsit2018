...
<section class="innerbanner" role="banner">
  <header id="header"> 
    <!-- navigation section  -->
    <div class="header-content clearfix"> <a class="logo" href="/"><img src="images/logo.png" alt="Jamiu Umar"></a>
      <nav class="navigation" role="navigation">
        <ul class="primary-nav">
          <li><a href="/umar">Umar</a></li>
          <li><a href="/aboutumar">About Me</a></li>
          <li><a href="/contactumar">Contact</a></li>
        </ul>
      </nav>
