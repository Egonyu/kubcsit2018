...
<section class="innerbanner" role="banner">
  <header id="header"> 
    <!-- navigation section  -->
    <div class="header-content clearfix"> <a class="logo" href="/"><img src="images/logo.png" alt="Jamiu Abdalla"></a>
      <nav class="navigation" role="navigation">
        <ul class="primary-nav">
          <li><a href="/abdalla">Abdalla</a></li>
          <li><a href="/aboutabdalla">About Me</a></li>
          <li><a href="/contactabdalla">Contact</a></li>
        </ul>
      </nav>
