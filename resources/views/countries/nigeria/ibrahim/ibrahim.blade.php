...
<section class="banner" role="banner">
  <header id="header"> 
    <!-- navigation section  -->
    <div class="header-content clearfix"> <a class="logo" href="/"><img src="images/logo.png" alt="Lawal"></a>
      <nav class="navigation" role="navigation">
        <ul class="primary-nav">
          <li><a href="/ibrahim">Home</a></li>
          <li><a href="/aboutibrahim">About Me</a></li>
          <li><a href="contactibrahim">Contact</a></li>
        </ul>
      </nav>
