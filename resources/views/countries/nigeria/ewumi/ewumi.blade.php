...
<title>Ewumi Muhammed Saliu</title>
...
<section class="banner" role="banner">
  <header id="header"> 
    <!-- navigation section  -->
    <div class="header-content clearfix"> <a class="logo" href="/"><img src="images/logo.png" alt="Ewumi"></a>
      <nav class="navigation" role="navigation">
        <ul class="primary-nav">
          <li><a href="/ewumi">Home</a></li>
          <li><a href="/aboutewumi">About Me</a></li>
          <li><a href="contactewumi">Contact</a></li>
        </ul>
      </nav>
  ...
  <div class="container">
    <div class="col-md-10 col-md-offset-1">
      <div class="banner-text text-center">
        <h1>Hey, I’m Ewumi Muhammed Saliu </h1>
