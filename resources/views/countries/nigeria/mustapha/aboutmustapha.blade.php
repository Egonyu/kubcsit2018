...
<title>Mustapha Abubakar Imam</title>
...
<section class="innerbanner" role="banner">
  <header id="header"> 
    <!-- navigation section  -->
    <div class="header-content clearfix"> <a class="logo" href="/"><img src="images/logo.png" alt="Mustapha"></a>
      <nav class="navigation" role="navigation">
        <ul class="primary-nav">
          <li><a href="/mustapha">Mustapha</a></li>
          <li><a href="/aboutmustapha">About Me</a></li>
          <li><a href="/contactmustapha">Contact</a></li>
        </ul>
      </nav>
...
<section id="inner-description" class="section inner-description">
  <div class="container">
    <div class="col-md-10 col-md-offset-1 text-center"> <img src="images/designer-pic.jpg" alt="Mafolio">
      <h1>Mustapha Abubakar Imam</h1>
      <p>Fullstack Designer/ Developer & Hacker</p>
    </div>
