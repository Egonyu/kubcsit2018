...
<section class="banner" role="banner">
  <header id="header"> 
    <!-- navigation section  -->
    <div class="header-content clearfix"> <a class="logo" href="/"><img src="images/logo.png" alt="Ayoub"></a>
      <nav class="navigation" role="navigation">
        <ul class="primary-nav">
          <li><a href="/ayoub">Ayoub</a></li>
          <li><a href="/aboutayoub">About Me</a></li>
          <li><a href="contactayoub">Contact</a></li>
        </ul>
      </nav>
