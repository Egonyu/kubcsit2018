...
<section class="banner" role="banner">
  <header id="header"> 
    <!-- navigation section  -->
    <div class="header-content clearfix"> <a class="logo" href="/"><img src="images/logo.png" alt="Tandele"></a>
      <nav class="navigation" role="navigation">
        <ul class="primary-nav">
          <li><a href="/tandele">Tandele</a></li>
          <li><a href="/abouttandele">About Me</a></li>
          <li><a href="/contacttandele">Contact</a></li>
        </ul>
      </nav>
