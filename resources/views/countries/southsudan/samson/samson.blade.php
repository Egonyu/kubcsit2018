...
<section class="banner" role="banner">
  <header id="header"> 
    <!-- navigation section  -->
    <div class="header-content clearfix"> <a class="logo" href="/"><img src="images/logo.png" alt="Samson"></a>
      <nav class="navigation" role="navigation">
        <ul class="primary-nav">
          <li><a href="/samson">Samson</a></li>
          <li><a href="/aboutsamson">About Me</a></li>
          <li><a href="/contactsamson">Contact</a></li>
        </ul>
      </nav>
