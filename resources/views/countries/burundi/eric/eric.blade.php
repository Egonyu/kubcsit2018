...
<section class="banner" role="banner">
  <header id="header"> 
    <!-- navigation section  -->
    <div class="header-content clearfix"> <a class="logo" href="/"><img src="images/lo.png" style="width: 90px; margin-top: -40px;"  alt="Eric"></a>
      <nav class="navigation" role="navigation">
        <ul class="primary-nav">
          <li><a href="/eric">Eric</a></li>
          <li><a href="/abouteric">About Me</a></li>
          <li><a href="/contacteric">Contact</a></li>
        </ul>
      </nav>
  ...
  <div class="container">
    <div class="col-md-10 col-md-offset-1">
      <div class="banner-text text-center">
        <h1><a class="color" href="/eric">Hey, I’m Nzohabonayo Eric</a></h1>
        <p>Looking for a strategist and experienced Web designer,<br>
...
<script src="js/js/retina.min.js"></script> 
